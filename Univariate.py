class Univariate():
    ...
    def Univariate(dataset,quan):
        ...
        for columnName in quan:
            ...
            descriptive.loc["99%",columnName]=np.percentile(dataset.describe()[columnName],100)
            ...
            descriptive.loc["1.5IQR", columnName]=1.5*descriptive[columnName]["IQR"]
            descriptive.loc["LesserRange", columnName]=descriptive[columnName]["Q1:25%"]- descriptive[columnName]["1.5IQR"]
            descriptive.loc["GreaterRange", columnName]=descriptive[columnName]["Q3:75%"]+ descriptive[columnName]["1.5IQR"]
